...
def googleTranslate(content):
    ...
    # url = 'https://translate.google.com.tw/?hl=zh-TW#view=home&op=translate&sl=auto&tl=zh-TW&text={}'.format(content.replace(" ", "%20"))
    ...
    # bs = testEncode(html)
    # result = bs.find('span', {'class': 'tlid-translation translation'})
    # return bs.find('span', {'class': 'tlid-translation translation'}).get_text()
...
if __name__ == "__main__":
    ...
    while True:
        ...
        keyboard.add_hotkey('ctrl+q', func_quit, suppress = True)
        window.mainloop()
